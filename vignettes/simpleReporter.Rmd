...
> **⚠️ Important Notice**: The `ReportCard` class is deprecated. Users should use the `teal_report` class instead for new implementations. For more information about the `teal_report` class, see the [teal_report class vignette](./teal-report-class.html).
