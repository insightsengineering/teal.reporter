...
Report previewer is a `shiny` module to visualize and manipulate the already added report cards, and eventually downloading a report document.
Report previewer is extended by the base modules introduced in the `simpleReporter` vignette.
