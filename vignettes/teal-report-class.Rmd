...
A `teal_report` is an object where developers can add, edit and remove various content (markdown text, plots, tables), evaluate and add code chunks within its environment. It provides a framework for building reproducible reports by combining content management with automatic code tracking.
