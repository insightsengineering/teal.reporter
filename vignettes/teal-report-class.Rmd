...
This vignette shows you how to build `teal_report` object, add remove its content.

## Creating a teal_report

A `teal_report` is an object where developers can add, edit and remove various content (e.g. markdown content, plots, tables), add evaluate code chunks. It provides a framework for building reproducible reports by combining content management with automatic code tracking.
