...
TableBlock <- R6::R6Class( # nolint: object_name_linter.
  ...
  public = list(
    ...
    #'
    #' @param table (`data.frame`, `rtables`, `TableTree`, `ElementaryTable`, `listing_df`) a table assigned to this `TableBlock`
    #'
    ...
    #'
    #' @param content (`data.frame`, `rtables`, `TableTree`, `ElementaryTable`, `listing_df`) a table assigned to this `TableBlock`
    #'
