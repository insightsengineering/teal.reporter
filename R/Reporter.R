...
Reporter <- R6::R6Class( # nolint: object_name_linter.
  ...
  public = list(
    ...
    #'
    initialize = function() {
      private$cards <- withReactiveDomain(NULL, do.call(shiny::reactiveValues, list()))
      private$cached_html <- withReactiveDomain(NULL, do.call(shiny::reactiveValues, list()))
      private$open_previewer_r <- withReactiveDomain(NULL, do.call(shiny::reactiveVal, list(NULL)))
      invisible(self)
    },
