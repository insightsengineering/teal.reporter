...
testthat::test_that("PictureBlock object can be created", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new(),
    regexp = NA
  )
})

testthat::test_that("new returns an object of type PictureBlock", {
  testthat::expect_true(inherits(teal.reporter::PictureBlock$new(), "PictureBlock"))
})
...
testthat::test_that("get_content returns character(0) on a newly initialized PictureBlock", {
  testthat::expect_equal(
    teal.reporter::PictureBlock$new()$get_content(),
    character(0)
  )
})
...
testthat::test_that("set_title accepts a string", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_title("Test"),
    NA
  )
})
...
testthat::test_that("set_title asserts the argument is string", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_title(8),
...
testthat::test_that("set_dim accepts an array of two numeric values", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_dim(c(0, 0)),
    regexp = NA
  )
})
...
testthat::test_that("set_dim asserts the argument is an array of two numeric values", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_dim("test"),
    regexp = "Must be of type 'numeric'"
  )
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_dim(c(8, 1, 1)),
...
testthat::test_that("set_content throws if the content is not of the supported type", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_content("unsupported content"),
...
testthat::test_that("set_content accepts a `grob` object", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_content(ggplot2::ggplotGrob(ggplot2::ggplot(iris))),
    regexp = NA
  )
})
...
testthat::test_that("set_content accepts a `trellis` object", {
  testthat::expect_error(
    teal.reporter::PictureBlock$new()$set_content(lattice::bwplot(1)),
    regexp = NA
  )
})
...
testthat::test_that("to_list returns a named list with a one field, a proper path", {
  pblock <- teal.reporter::PictureBlock$new()$set_content(ggplot2::ggplot(iris))
  temp_dir <- tempdir()
  testthat::expect_identical(
...
testthat::test_that("from_list after to_list to save and retrive", {
  ...
  temp_dir <- tempdir()
  testthat::expect_identical(
    file.size(teal.reporter::PictureBlock$new()$from_list(
      pblock$to_list(temp_dir),
